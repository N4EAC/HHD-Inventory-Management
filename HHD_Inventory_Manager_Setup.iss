...
#define MyAppBuildDir "dist\windows\HHD_Inventory_Manager"
...
OutputBaseFilename=HHD_Inventory_Manager_Setup_v1.5.9.1
...
Source: "hhd_inventory_manager_about.png"; DestDir: "{app}"; Flags: ignoreversion
